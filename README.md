...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/benny#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/benny
```

A live public deployment of this template is available at [https://benny.templates.workers.dev](https://benny.templates.workers.dev)
